<template>
	...
	<div
		class="flight_wrapper flight"
	>
		<!-- Card Title Start -->
		<h1
			class="custom-text-4xl font-bold text-white"
		>
		...
		<!-- Card Text Start -->
		<h2
			class="custom-text-base font-regular text-center text-background"
		>
