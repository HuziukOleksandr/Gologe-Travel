<template>
	...
	>
		...
		<!-- Inputs "Depart Return" wrapper End -->
		...
		>
			...
			<!-- Use Custom Input "Pasenger Class" End -->
		...
		<!-- Inputs "Pasenger Class" wrapper End -->
	</div>
	<!-- Inputs wrapper End -->
	...
	>
		...
		<CustomButton
			class="h-[48px] p-[16px] font-medium"
		>
