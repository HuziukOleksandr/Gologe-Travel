		...
		>
			...
			>
				...
				>
					<!-- Title Start -->
					<h1
						class="custom-text-2xl font-bold text-white "
					>
						{{ card.title }}
					</h1>
					<!-- Title End -->
					...
					<!-- Sub Title Start -->
					<p
						class="custom-text-sm font-regular text-white"
					>
						{{ card.subTitle }}
					</p>
					<!-- Sub Title End -->
...
.content_wrapper {
	@apply
	max-w-[248px] w-full flex flex-col gap-[16px] 
	absolute left-[50%] translate-x-[-50%] bottom-[24px]
}

.button {
	@apply
	w-full font-medium text-green bg-buttonGreen h-[48px] justify-center
}
