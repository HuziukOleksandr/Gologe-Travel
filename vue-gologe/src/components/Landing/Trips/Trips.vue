<template>
	<!-- Trips wrapper Start -->
	<div
		class="max-w-[1230px] w-full min-h-[280px] flex flex-col gap-[40px]"
	>
		...
		>
			<!-- Text wrapper Start -->
			<div 
				class="max-w-[1060px] w-full flex flex-col gap-[15px]"
			>
				<!-- Title Start -->
				<h1
		...
		<div
			class="w-full h-[560px] flex justify-between"
		>
		...
		<!-- Content for Large Cards wrapper End -->
	</div>
	<!-- Trips wrapper End -->
</template>
